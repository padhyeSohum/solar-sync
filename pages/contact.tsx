    ...
    return (
        ...
        >
            ...
            <div className="w-full h-screen flex flex-col justify-center place-items-center relative">
                ...
                <h3 className="w-[7/12] text-xl leading-[150%] text-center p-8 bg-foreground-20 rounded-xl">For any business inquiries, please reach out to us at this email:<br/> <a className="text-blue-500 transition-all duration-300 hover:underline" href= "mailto: solar.sync.team@gmail.com">solar.sync.team@gmail.com</a></h3>
            </div>
        </main>
    );
}